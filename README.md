...
#### Project Structure
    ...
    │   │   │   │   │   │   ├── CustomerPurchase.java   # Customer purchase data model
    │   │   │   │   │   ├── util/
    │   │   │   │   │   │   ├── DatabaseConnection.java # Database connection utility
    │   │   │   │   │   ├── controller/
    │   │   │   │   │   │   ├── LoginController.java    # Login page controller
    │   │   │   │   │   │   ├── admin/
    │   │   │   │   │   │   │   ├── AdminHomeController.java # Admin home page
    │   │   │   │   │   │   │   ├── ProductController.java   # Product management
    │   │   │   │   │   │   │   ├── EmployeeController.java  # Employee management
    │   │   │   │   │   │   ├── employee/
    │   │   │   │   │   │   │   ├── EmployeeHomeController.java # Employee home page
    │   │   │   │   │   │   │   ├── CalculatorChangeController.java # Change calculator
    │   │   │   │   │   │   │   ├── ReceiptController.java      # Receipt display
    │   │   │   │   │   ├── service/
    │   │   │   │   │   │   ├── ProductService.java     # Business logic for products
    │   │   │   │   │   │   ├── EmployeeService.java    # Business logic for employees
    │   │   │   │   │   │   ├── PurchaseService.java    # Business logic for purchases
    │   │   ├── resources/
    │   │   │   ├── com/
    │   │   │   │   ├── supermarket/
    │   │   │   │   │   ├── fxml/
    │   │   │   │   │   │   ├── login-page.fxml         # Login UI
    │   │   │   │   │   │   ├── admin/
    │   │   │   │   │   │   │   ├── home-page.fxml      # Admin home UI
    │   │   │   │   │   │   │   ├── product-page.fxml   # Product management UI
    │   │   │   │   │   │   │   ├── employee-page.fxml  # Employee management UI
    │   │   │   │   │   │   ├── employee/
    │   │   │   │   │   │   │   ├── home-page.fxml      # Employee home UI
    │   │   │   │   │   │   │   ├── calculator-change.fxml # Change calculator UI
    │   │   │   │   │   │   │   ├── receipt.fxml        # Receipt UI
    │   │   │   │   │   ├── css/
    ...
    │   │   │   │   ├── supermarket/
    │   │   │   │   │   ├── controller/
    │   │   │   │   │   │   ├── LoginControllerTest.java # Unit tests
    │   ├── sql/
